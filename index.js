if(typeof ethereum === "undefined") {
    const link = "https://metamask.app.link/dapp/" + location.host;
    const a = document.createElement("a");
    a.href = link;
    a.innerHTML = "Instalar Metamask";
...
async function renderTareas() {
	...
	for (var i = 1; i <= contTareas; i++) {
		...
		$newTaskTemplate
			.find("input")[0]
			.style.setProperty("--text-color", brightness > 128 ? "black" : "white");
		...
		$newTaskTemplate.find("button").on("click", () => eliminarTarea(ethereum.selectedAddress, Id));
